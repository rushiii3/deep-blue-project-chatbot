...
import "../../App.css";
import HeroLogo from "../../assets/8e6421c1-3360-439e-b428-966ec5a2074e Background Removed.png";
import { Link } from "react-router-dom";
const InfoSection = () => {
  return (
    // <div className="relative items-center justify-center w-full lg:pt-36 lg:pb-36 xl:pt-36 xl:pb-52">
    ...
    //     <div className="z-30 overflow-hidden flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
    //       <h1 className="relative mb-6  text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">
    ...
    //       </svg>
    //     </div>
    //     <div className="relative z-3 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
      ...
      <div class="relative z-20 mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <div className="flex flex-row items-center justify-center gap-5">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <Link
                to={"https://github.com/rushiii3/deep-blue-project-chatbot"}
                class="isomorphic-link isomorphic-link--internal inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                Get Code
                <svg
        ...
        <div class="relative mx-auto mt-10 max-w-lg">
          <img
            ...
            src="https://static.wixstatic.com/media/3eee0b_8b6780c6bd8245ecafdbe55d8db7e2df~mv2.gif"
            alt=""
          />
        </div>
      </div>
